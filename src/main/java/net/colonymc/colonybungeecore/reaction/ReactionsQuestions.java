...
public class ReactionsQuestions {
	...
	static final ArrayList<String[]> math = new ArrayList<>();
	static final ArrayList<String> write = new ArrayList<>();
	static final ArrayList<String[]> unscramble = new ArrayList<>();
